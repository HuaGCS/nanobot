...
- Persona workspaces may include optional `PROFILE.md`, `STYLE.md`, and `LORE.md`. `PROFILE.md` is the user-model layer for stable user facts/preferences and should load as a separate user-profile section; `STYLE.md` and `LORE.md` should continue loading after `SOUL.md` and `USER.md`.
